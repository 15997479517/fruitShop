											...
											<div class="mini_cart_box cart_box_two mini_cart_two">
												...
												<div class="mini_cart_item">
													...
													<div class="cart_info cart_info_two">
														...
														<span class="cart_price">$60.99</span>
													</div>
													<div class="cart_remove">
														<a href="#"><i class="zmdi zmdi-delete"></i></a>
													</div>
            ...
            <div class="organic_food_wrapper">    
                ...
                <div class="slider_area slider_area_two">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide single_slide_two" style="background-image: url(${pageContext.request.contextPath}/assets/img/banner/banner1_home2.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="single_slide single_slide_two" style="background-image: url(${pageContext.request.contextPath}/assets/img/banner/banner2_home2.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="shipping_list d-flex justify-content-between">
                                    ...
                                    <div class="single_shipping_box two d-flex">
                                        <div class="shipping_icon">
                                            <img src="${pageContext.request.contextPath}/assets/img/ship/3.png" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
							...
							<div class="col-lg-6 col-md-12">
								<div class="Category_product_banner">
									<div class="Category_banner_inner">
										<a href="#"><img src="${pageContext.request.contextPath}/assets/img/banner/static2_img_home2.jpg" alt=""></a>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="shop_product_head shop__two d-flex justify-content-between mb-30">
									...
									<div class="home_shop_product text-right">
										<ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist"> 
											<li><a class="active" href="#cucumber " data-toggle="tab" role="tab" aria-selected="false" aria-controls="cucumber"> Cucumber </a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active show fade" id="cucumber" role="tabpanel">
										<div class="row">
                ...
                <!--Recommended product area end-->
				 ...
				 <!--New product area-->
                <div class="new_product home_2 pt-30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="section_title space_2 text-left">
                ...
                <!--new product end-->
				 ...
				 <!--Banner area start-->
                <div class="banner_area banner_area-2 two pb-90">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-3 col-xs-12">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/banner-4.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xs-12">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/banner-5.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-xs-12">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/banner-6.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <!--Best seller product -->
                <div class="best_seller_product two">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="section_title space_2 text-left">
                                    ...
                                    <div class="best_selling_product">
                                        <div class="single_small_product mb-30">
                                            ...
                                            <div class="product_content">
                                                ...
                                                <div class="product_price">
                                                    <span class="regular_price">$70.99</span>
                                                    <span class="old_price">$62.23</span>
                                                </div>
                                            </div>
                                        </div>
