            ...
            <div class="organic_food_wrapper">
                ...
                <div class="slider_area">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide" style="background-image: url(${pageContext.request.contextPath}/assets/img/slider/1.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="single_slide" style="background-image: url(${pageContext.request.contextPath}/assets/img/slider/2.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner banner_three">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="shop_larg_product">
                                    <div class="single__product_2">
                                        <div class="product_img">
                                            <a href="#">
                                                <img src="${pageContext.request.contextPath}/assets/img/product/big-1.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content text-center">
                                            <div class="product_title">
                                                    ...
                                                    <div class="shop_single_prduct_item">
                                                        ...
                                                        <div class="single__product">
                                                            <div class="single_product__inner">
                                                                ...
                                                                <div class="product_img">
                                                                    <a href="#">
                                                                        <img src="${pageContext.request.contextPath}/assets/img/product/11.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product__content text-center">
                                                                    <div class="produc_desc_info">
                                                        ...
                                                        <div class="single__product">
                                                            <div class="single_product__inner">
                                                                ...
                                                                <div class="product_img">
                                                                    <a href="#">
                                                                        <img src="${pageContext.request.contextPath}/assets/img/product/12.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="product__content text-center">
                                                                    <div class="produc_desc_info">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/big-1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/big-2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
