...
<html class="no-js" lang="zxx">
    ...
    <body>
			...
			<div class="breadcrumb_container">
         	...
         	<div class="organic_food_wrapper">        
                <!--- shop_wrapper area  -->
                <div class="shop_wrapper shop_right_sidebar ptb-90">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-12 col-12">
                                <div class="categories_banner">
                                    <div class="categories_banner_inner">
                                        <img src="${pageContext.request.contextPath}/assets/img/banner/shop.jpg" alt="">
                                    </div>
                                    <h3>SHOP</h3>
                                </div>
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-4 col-md-5 col-sm-5">
                                                        <div class="single_product__inner inner_shop">
                                                            ...
                                                            <div class="product_img">
                                                                <a href="#">
                                                                    <img src="${pageContext.request.contextPath}/assets/img/product/207.jpg" alt="">
                                                                </a>
                                                            </div>
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-4 col-md-5 col-sm-5">
                                                        <div class="single_product__inner inner_shop">
                                                            ...
                                                            <div class="product_img">
                                                                <a href="#">
                                                                    <img src="${pageContext.request.contextPath}/assets/img/product/103.jpg" alt="">
                                                                </a>
                                                            </div>
